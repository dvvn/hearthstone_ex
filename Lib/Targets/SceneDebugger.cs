...
namespace hearthstone_ex.Targets
{
	...
	public class SceneDebugger : LoggerGui.Static<SceneDebugger>
	{
		[HarmonyPrefix]
		...
		private sealed class GameplayWindowCloser
		{
			...
			public void Update()
			{
				...
				_wantFix = state != null && state.GetSlushTimeTracker().GetAccruedLostTimeInSeconds() >
					GameplayDebug.LOST_SLUSH_TIME_ERROR_THRESHOLD_SECONDS;
				TryEndableLogging();
			}
			...
			public GameplayWindowCloser(DebuggerGuiWindow window)
			{
